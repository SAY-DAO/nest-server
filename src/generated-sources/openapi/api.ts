...
export const NeedAPIApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2NeedsGet(authorization: string, X_SKIP?: number, X_TAKE?: number, isConfirmed?: boolean, isDone?: boolean, isReported?: boolean, status?: string, type?: number, ngoId?: number, isChildConfirmed?: boolean, unpayable?: boolean, createdBy?: number, confirmedBy?: number, purchasedBy?: number, options: any = {}): FetchArgs {
            // verify required parameter 'authorization' is not null or undefined
            if (authorization === null || authorization === undefined) {
...
export const NeedAPIApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2NeedsGet(authorization: string, X_SKIP?: number, X_TAKE?: number, isConfirmed?: boolean, isDone?: boolean, isReported?: boolean, status?: string, type?: number, ngoId?: number, isChildConfirmed?: boolean, unpayable?: boolean, createdBy?: number, confirmedBy?: number, purchasedBy?: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = NeedAPIApiFetchParamCreator(configuration).apiV2NeedsGet(authorization, X_SKIP, X_TAKE, isConfirmed, isDone, isReported, status, type, ngoId, isChildConfirmed, unpayable, createdBy, confirmedBy, purchasedBy, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const NeedAPIApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV2NeedsGet(authorization: string, X_SKIP?: number, X_TAKE?: number, isConfirmed?: boolean, isDone?: boolean, isReported?: boolean, status?: string, type?: number, ngoId?: number, isChildConfirmed?: boolean, unpayable?: boolean, createdBy?: number, confirmedBy?: number, purchasedBy?: number, options?: any) {
            return NeedAPIApiFp(configuration).apiV2NeedsGet(authorization, X_SKIP, X_TAKE, isConfirmed, isDone, isReported, status, type, ngoId, isChildConfirmed, unpayable, createdBy, confirmedBy, purchasedBy, options)(fetch, basePath);
        },
        /**
         * <br/>
         * @summary List receipts for a need
...
export class NeedAPIApi extends BaseAPI {
     ...
     * @memberof NeedAPIApi
     */
    public apiV2NeedsGet(authorization: string, X_SKIP?: number, X_TAKE?: number, isConfirmed?: boolean, isDone?: boolean, isReported?: boolean, status?: string, type?: number, ngoId?: number, isChildConfirmed?: boolean, unpayable?: boolean, createdBy?: number, confirmedBy?: number, purchasedBy?: number, options?: any) {
        return NeedAPIApiFp(this.configuration).apiV2NeedsGet(authorization, X_SKIP, X_TAKE, isConfirmed, isDone, isReported, status, type, ngoId, isChildConfirmed, unpayable, createdBy, confirmedBy, purchasedBy, options)(this.fetch, this.basePath);
    }
