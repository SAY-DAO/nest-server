...
export class New1695838710231 implements MigrationInterface {
    name = 'New1695838710231'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "city_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "flaskCityId" integer NOT NULL, "name" character varying, "stateId" integer, "stateCode" character varying, "stateName" character varying, "countryId" integer, "countryCode" character varying, "countryName" character varying, "latitude" character varying, "longitude" character varying, CONSTRAINT "PK_eab9b25f1f37e6d71b416ccdc4e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "ngo_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "flaskNgoId" integer, "name" character varying, "website" character varying, "flaskCityId" integer, "flaskStateId" integer, "flaskCountryId" integer, "postalAddress" character varying, "emailAddress" character varying, "phoneNumber" character varying, "logoUrl" character varying, "isActive" boolean NOT NULL DEFAULT false, "registerDate" TIMESTAMP WITH TIME ZONE, "created" TIMESTAMP WITH TIME ZONE, "updated" TIMESTAMP WITH TIME ZONE, "isDeleted" boolean, "cityId" uuid, CONSTRAINT "PK_3111eb08ec402c3eec998fca624" PRIMARY KEY ("id"))`);
