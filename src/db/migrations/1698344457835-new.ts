...
export class New1698344457835 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "children_pre_register_entity" RENAME COLUMN "cityObjectId" TO "locationId"`);
        await queryRunner.query(`ALTER TABLE "ngo_entity" RENAME COLUMN "cityObjectId" TO "locationId"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ngo_entity" RENAME COLUMN "locationId" TO "cityObjectId"`);
        await queryRunner.query(`ALTER TABLE "children_pre_register_entity" RENAME COLUMN "locationId" TO "cityObjectId"`);
